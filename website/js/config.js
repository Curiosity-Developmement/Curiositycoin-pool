var api = 'http://<your site>:8117' // Change this to your pools api, if ssl is not used its likely to be 'http://yourpooldomain.se:8117' 

var api_blockexplorer = 'http://curiositycoin.curiosityserver.ml/explorer/' // Leave this unchanged

var poolHost = '<your site>' // Change this to your pools site
...
var networkStat = {
  'xkr': [
    ['Curiositycoin', 'http://45.79.35.29:8117'],
